...
const Homepage = () => {
    ...
    const fetchProducts = async (category) => {
        ...
        await api.get("/product/all", {
            params: {
                search, page, order, sort, category
            }
        }).then((res) => {
        ...
        <div style={{ minHeight: "150vh" }}>
            ...
            <Tabs colorScheme="black">
                <TabList justifyContent="center" className="tab-list-home">
                    ...
                    <Tab onClick={() => fetchProducts(3)}>Earphone</Tab>

                </TabList>
                <div style={{ display:"flex", justifyContent:'center', marginTop:"10px"}}>
                <Stack flexDirection="row" alignItems="center" className='con-category'>
                    <Text fontSize="10px" width="50px">Sort By:</Text>
                    <Select placeholder='By name A~Z' width='120px' display="flex" justifyContent="center" style={{ fontSize: '10px' }} onChange={(e) => handleSorting(e.target.value)}>
                        <option value='1' style={{ fontSize: '10px' }}>By name Z~A</option>
                        <option value='2' style={{ fontSize: '10px' }}>By price low~high</option>
                        <option value='3' style={{ fontSize: '10px' }}>By price high~low</option>
                    </Select>

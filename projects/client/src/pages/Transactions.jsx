...
export const Transaction = () => {
  ...
  return (
    <div className="pt-24 mx-auto flex h-10 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="flex items-center justify-between py-4">
                    <div className="flex items-center">
                      ...
                      <button
                        ...
                        className="px-5 py-2 ml-4 text-sm font-medium text-black hover:bg-slate-50 rounded-full bg-slate-100">
                        Cancel Order
                      </button>
                    </div>
                  </div>

...
module.exports = {
    addToCart: async (req, res) => {
        try {
            ...
            const cartItem = await Carts.findOne({ where: { id_user: userId, id_product: productId } });
            ...
            if (cartItem) {
                ...
                await Carts.create({ id_user: userId, id_product: productId, quantity });
            }

            return res.status(200).send({ message: 'Product added to cart successfully', totalCart });
        } catch (error) {
            console.error(error);
    ...
    updateCartProduct: async (req, res) => {
        try {
            ...
            if (cartItem) {
                ...
                return res
                    .status(200)
                    .send({ message: "Cart item updated successfully", quantity, cartItems, subtotal });
            }
